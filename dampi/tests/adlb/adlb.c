...
static char *svn_revision = "$Revision: 414 $";
static char *svn_date = "$LastChangedDate: 2009-12-12 17:40:21 -0700 (Sat, 12 Dec 2009) $";
...
static int num_world_nodes, num_servers, next_wqseqno, next_rqseqno, next_cqseqno,
           ...
           using_debug_server, debug_server_rank, *user_types, dprintf_flag;
...
#           endif
        ...
        rc = MPI_Test(&qmstat_req,&msg_available,&status);
        if ( ! msg_available )
