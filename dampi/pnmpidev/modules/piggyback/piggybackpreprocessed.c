...
# 1 "piggyback.c"
# 1 "/home/avo/research/pnmpi/pnmpidev/modules/piggyback//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "piggyback.c"
...
int PMPIX_Grequest_start(MPI_Grequest_query_function *,
         ...
         MPIX_Grequest_wait_function *, void *, MPI_Request *);
# 6 "piggyback.c" 2
# 1 "/home/avo/research/pnmpi/pnmpi/include/pnmpimod.h" 1
# 12 "/home/avo/research/pnmpi/pnmpi/include/pnmpimod.h"
# 1 "/home/avo/research/pnmpi/pnmpi/include/pnmpi.h" 1
...
# 1 "/home/avo/research/pnmpi/pnmpi/include/pnmpimod.h" 1
# 7 "/home/avo/research/pnmpi/pnmpi/include/pnmpi.h" 2
# 13 "/home/avo/research/pnmpi/pnmpi/include/pnmpimod.h" 2
# 52 "/home/avo/research/pnmpi/pnmpi/include/pnmpimod.h"
...
# 91 "/home/avo/research/pnmpi/pnmpi/include/pnmpimod.h"
...
# 1 "/home/avo/research/pnmpi/pnmpi/include/newstack.h" 1
...
# 118 "/home/avo/research/pnmpi/pnmpi/include/pnmpimod.h" 2
# 134 "/home/avo/research/pnmpi/pnmpi/include/pnmpimod.h"
void PNMPI_Service_log(char *format,...);
# 157 "/home/avo/research/pnmpi/pnmpi/include/pnmpimod.h"
int PNMPI_Service_QueryModule(char *name, int *locinfo);
# 7 "piggyback.c" 2

# 1 "/home/avo/research/pnmpi/pnmpi/include/requests.h" 1

# 1 "/home/avo/research/pnmpi/pnmpi/include/status.h" 1
# 41 "/home/avo/research/pnmpi/pnmpi/include/status.h"
typedef int (*PNMPIMOD_Status_RequestStorage_t)(int);
int PNMPIMOD_Status_RequestStorage(int size);
# 3 "/home/avo/research/pnmpi/pnmpi/include/requests.h" 2
# 36 "/home/avo/research/pnmpi/pnmpi/include/requests.h"
...
# 84 "/home/avo/research/pnmpi/pnmpi/include/requests.h"
...
int MPI_Send(void *buf, int count, MPI_Datatype datatype, int dest, int tag, MPI_Comm comm)
{
  ...
  ;
# 740 "piggyback.c"
  err=PMPI_Send(pb_outbuffer,piggyback_size,((MPI_Datatype)0x4c000101),dest,tag,comm);
  if (err==0)
...
int MPI_Rsend(void *buf, int count, MPI_Datatype datatype, int dest, int tag, MPI_Comm comm)
{
  ...
  ;
# 828 "piggyback.c"
  err=PMPI_Rsend(pb_outbuffer,piggyback_size,((MPI_Datatype)0x4c000101),dest,tag,comm);
  if (err==0)
    err=PMPI_Send(buf,count,datatype,dest,tag,comm);
# 855 "piggyback.c"
  return err;
...
int MPI_Ssend(void *buf, int count, MPI_Datatype datatype, int dest, int tag, MPI_Comm comm)
{
  ...
  ;
# 872 "piggyback.c"
  err=PMPI_Ssend(pb_outbuffer,piggyback_size,((MPI_Datatype)0x4c000101),dest,tag,comm);
  if (err==0)
    err=PMPI_Send(buf,count,datatype,dest,tag,comm);
# 899 "piggyback.c"
  return err;
...
# 924 "piggyback.c"
  ...
  err=PMPI_Isend(ptr,piggyback_size,((MPI_Datatype)0x4c000101),dest,tag,comm,request);
  if (err==0)
    err=PMPI_Isend(buf,count,datatype,dest,tag,comm,&tmp_request);
  { PNMPIMOD_Requests_Parameters_t* _store; _store=PNMPIMOD_requestmap(*request); _store->data= (char*) malloc(sizeof(void**)); (*((void**) (&(_store->data[request_offset]))))=ptr;};;
  { PNMPIMOD_Requests_Parameters_t* _store; _store=PNMPIMOD_requestmap(*request); _store->data= (char*) malloc(sizeof(MPI_Request*)); (*((MPI_Request*) (&(_store->data[request_offset_req]))))=tmp_request;};;
# 959 "piggyback.c"
  return err;
}
...
# 980 "piggyback.c"
  { ptr=(char*) malloc(piggyback_size); if (ptr==((void *)0)) { return 16; } };
  memcpy(ptr,pb_outbuffer,piggyback_size);;
  err=PMPI_Ibsend(ptr,piggyback_size,((MPI_Datatype)0x4c000101),dest,tag,comm,request);
  if (err==0)
...
# 1036 "piggyback.c"
  { ptr=(char*) malloc(piggyback_size); if (ptr==((void *)0)) { return 16; } };
  memcpy(ptr,pb_outbuffer,piggyback_size);;
  err=PMPI_Irsend(ptr,piggyback_size,((MPI_Datatype)0x4c000101),dest,tag,comm,request);
  if (err==0)
    err=PMPI_Isend(buf,count,datatype,dest,tag,comm,&tmp_request);
  { PNMPIMOD_Requests_Parameters_t* _store; _store=PNMPIMOD_requestmap(*request); _store->data= (char*) malloc(sizeof(void**)); (*((void**) (&(_store->data[request_offset]))))=ptr;};;
  { PNMPIMOD_Requests_Parameters_t* _store; _store=PNMPIMOD_requestmap(*request); _store->data= (char*) malloc(sizeof(MPI_Request*)); (*((MPI_Request*) (&(_store->data[request_offset_req]))))=tmp_request;};;
...
# 1092 "piggyback.c"
  { ptr=(char*) malloc(piggyback_size); if (ptr==((void *)0)) { return 16; } };
  memcpy(ptr,pb_outbuffer,piggyback_size);;
  err=PMPI_Issend(ptr,piggyback_size,((MPI_Datatype)0x4c000101),dest,tag,comm,request);
  if (err==0)
    err=PMPI_Isend(buf,count,datatype,dest,tag,comm,&tmp_request);
  { PNMPIMOD_Requests_Parameters_t* _store; _store=PNMPIMOD_requestmap(*request); _store->data= (char*) malloc(sizeof(void**)); (*((void**) (&(_store->data[request_offset]))))=ptr;};;
  { PNMPIMOD_Requests_Parameters_t* _store; _store=PNMPIMOD_requestmap(*request); _store->data= (char*) malloc(sizeof(MPI_Request*)); (*((MPI_Request*) (&(_store->data[request_offset_req]))))=tmp_request;};;
...
int MPI_Recv(void *buf, int count, MPI_Datatype datatype, int source, int tag, MPI_Comm comm, MPI_Status *status)
{
  ...
  MPI_Status status2;
# 1152 "piggyback.c"
  err=PMPI_Recv(&((*((char*) (((char*) (status))+1*sizeof(MPI_Status)+0*0 +piggyback_offset)))),piggyback_size,((MPI_Datatype)0x4c000101),source,tag,comm,&status2);
  if (err==0)
...
# 1215 "piggyback.c"
  { ptr=(char*) malloc(piggyback_size); if (ptr==((void *)0)) { return 16; } };
  err=PMPI_Irecv(ptr,piggyback_size,((MPI_Datatype)0x4c000101),source,tag,comm,request);
  if ((source!=(-2)) && (tag!=(-1)) && (err==0))
    {
      err=PMPI_Irecv(buf,count,datatype,source,tag,comm,&tmp_request);
  fprintf(stderr, "piggyback code line %d\n", 1220);
      { PNMPIMOD_Requests_Parameters_t* _store; _store=PNMPIMOD_requestmap(*request); _store->data= (char*) malloc(sizeof(void**)); (*((void**) (&(_store->data[request_offset]))))=ptr;};;
  fprintf(stderr, "piggyback code line %d\n", 1222);
      { PNMPIMOD_Requests_Parameters_t* _store; _store=PNMPIMOD_requestmap(*request); _store->data= (char*) malloc(sizeof(MPI_Request*)); (*((MPI_Request*) (&(_store->data[request_offset_req]))))=tmp_request;};;
  fprintf(stderr, "piggyback code line %d\n", 1224);
    ...
    {
      { PNMPIMOD_Requests_Parameters_t* _store; _store=PNMPIMOD_requestmap(*request); _store->data= (char*) malloc(sizeof(void**)); (*((void**) (&(_store->data[request_offset]))))=ptr;};;
      { PNMPIMOD_Requests_Parameters_t* _store; _store=PNMPIMOD_requestmap(*request); _store->data= (char*) malloc(sizeof(void**)); (*((void**) (&(_store->data[request_offset_buf]))))=buf;};;
      { PNMPIMOD_Requests_Parameters_t* _store; _store=PNMPIMOD_requestmap(*request); _store->data= (char*) malloc(sizeof(int*)); (*((int*) (&(_store->data[request_offset_ct]))))=count;};;
      { PNMPIMOD_Requests_Parameters_t* _store; _store=PNMPIMOD_requestmap(*request); _store->data= (char*) malloc(sizeof(MPI_Datatype*)); (*((MPI_Datatype*) (&(_store->data[request_offset_dt]))))=datatype;};;
    }
# 1256 "piggyback.c"
  return err;
}
...
# 1289 "piggyback.c"
  err=PMPI_Sendrecv(pb_outbuffer,piggyback_size,((MPI_Datatype)0x4c000101),dest,sendtag,
      &((*((char*) (((char*) (status))+1*sizeof(MPI_Status)+0*0 +piggyback_offset)))),piggyback_size,((MPI_Datatype)0x4c000101),source,recvtag,
      comm,&status2);
  if (err==0)
...
int MPI_Wait(MPI_Request *request, MPI_Status *status)
{
  ...
  if ((*((PNMPIMOD_Requests_Parameters_t*) (((char*) (status))+1*sizeof(MPI_Status)+0*0 +(*StatusOffsetInRequest)))).inreq!=((MPI_Request)0x2c000000))
    {
      { printf("StatusOffsetInRequest=%d, request_offset=%d\n", (*StatusOffsetInRequest), request_offset); void *ptr=(*((char**) (((char*) (status))+1*sizeof(MPI_Status)+0**TotalStatusExtension+*StatusOffsetInRequest+request_offset+sizeof(PNMPIMOD_Requests_Parameters_t)))); if ((*((PNMPIMOD_Requests_Parameters_t*) (((char*) (status))+1*sizeof(MPI_Status)+0**TotalStatusExtension+(*StatusOffsetInRequest)))).type==0x00) { printf("piggyback_offset=%d, TotalStatusExtension=%d, cnt= %d, i=%d, ptr=%d\n", piggyback_offset, *TotalStatusExtension, 1, 0, ptr); fflush(stdout); void* ptr2; ptr2=&((*((char*) (((char*) (status))+1*sizeof(MPI_Status)+0**TotalStatusExtension+piggyback_offset)))); memcpy(&((*((char*) (((char*) (status))+1*sizeof(MPI_Status)+0*(*TotalStatusExtension)+piggyback_offset)))),ptr,piggyback_size);; printf("here2\n"); fflush(stdout); if (((*((PNMPIMOD_Requests_Parameters_t*) (((char*) (status))+1*sizeof(MPI_Status)+0**TotalStatusExtension+(*StatusOffsetInRequest)))).tag!=(-1)) && ((*((PNMPIMOD_Requests_Parameters_t*) (((char*) (status))+1*sizeof(MPI_Status)+0**TotalStatusExtension+(*StatusOffsetInRequest)))).node!=(-2))) { status[0].MPI_ERROR=0; err=PMPI_Wait(&((*((MPI_Request*) (((char*) (status))+1*sizeof(MPI_Status)+0**TotalStatusExtension+*StatusOffsetInRequest+request_offset_req+sizeof(PNMPIMOD_Requests_Parameters_t))))),&(status[0])); } else { err=PMPI_Recv((*((void**) (((char*) (status))+1*sizeof(MPI_Status)+0**TotalStatusExtension+*StatusOffsetInRequest+request_offset_buf+sizeof(PNMPIMOD_Requests_Parameters_t)))), (*((int*) (((char*) (status))+1*sizeof(MPI_Status)+0**TotalStatusExtension+*StatusOffsetInRequest+request_offset_ct+sizeof(PNMPIMOD_Requests_Parameters_t)))), (*((MPI_Datatype*) (((char*) (status))+1*sizeof(MPI_Status)+0**TotalStatusExtension+*StatusOffsetInRequest+request_offset_dt+sizeof(PNMPIMOD_Requests_Parameters_t)))), status[0].MPI_SOURCE, status[0].MPI_TAG, (*((PNMPIMOD_Requests_Parameters_t*) (((char*) (status))+1*sizeof(MPI_Status)+0**TotalStatusExtension+(*StatusOffsetInRequest)))).comm, &(status[0])); } } if ((*((PNMPIMOD_Requests_Parameters_t*) (((char*) (status))+1*sizeof(MPI_Status)+0**TotalStatusExtension+(*StatusOffsetInRequest)))).type==0x01) { status[0].MPI_ERROR=0; err=PMPI_Wait(&((*((MPI_Request*) (((char*) (status))+1*sizeof(MPI_Status)+0**TotalStatusExtension+*StatusOffsetInRequest+request_offset_req+sizeof(PNMPIMOD_Requests_Parameters_t))))),&(status[0])); } free(ptr);};
    }
...
int MPI_Waitsome(int count, MPI_Request *array_of_requests, int *outcount, int *array_of_indices, MPI_Status *array_of_statuses)
{
      ...
      for (i=0; i<*outcount; i++)
 {
   if ((*((PNMPIMOD_Requests_Parameters_t*) (((char*) (array_of_statuses))+count*sizeof(MPI_Status)+i**TotalStatusExtension+(*StatusOffsetInRequest)))).inreq!=((MPI_Request)0x2c000000))
     {
       { printf("StatusOffsetInRequest=%d, request_offset=%d\n", (*StatusOffsetInRequest), request_offset); void *ptr=(*((char**) (((char*) (array_of_statuses))+count*sizeof(MPI_Status)+i**TotalStatusExtension+*StatusOffsetInRequest+request_offset+sizeof(PNMPIMOD_Requests_Parameters_t)))); if ((*((PNMPIMOD_Requests_Parameters_t*) (((char*) (array_of_statuses))+count*sizeof(MPI_Status)+i**TotalStatusExtension+(*StatusOffsetInRequest)))).type==0x00) { printf("piggyback_offset=%d, TotalStatusExtension=%d, cnt= %d, i=%d, ptr=%d\n", piggyback_offset, *TotalStatusExtension, count, i, ptr); fflush(stdout); void* ptr2; ptr2=&((*((char*) (((char*) (array_of_statuses))+count*sizeof(MPI_Status)+i**TotalStatusExtension+piggyback_offset)))); memcpy(&((*((char*) (((char*) (array_of_statuses))+count*sizeof(MPI_Status)+i*(*TotalStatusExtension)+piggyback_offset)))),ptr,piggyback_size);; printf("here2\n"); fflush(stdout); if (((*((PNMPIMOD_Requests_Parameters_t*) (((char*) (array_of_statuses))+count*sizeof(MPI_Status)+i**TotalStatusExtension+(*StatusOffsetInRequest)))).tag!=(-1)) && ((*((PNMPIMOD_Requests_Parameters_t*) (((char*) (array_of_statuses))+count*sizeof(MPI_Status)+i**TotalStatusExtension+(*StatusOffsetInRequest)))).node!=(-2))) { array_of_statuses[i].MPI_ERROR=0; err=PMPI_Wait(&((*((MPI_Request*) (((char*) (array_of_statuses))+count*sizeof(MPI_Status)+i**TotalStatusExtension+*StatusOffsetInRequest+request_offset_req+sizeof(PNMPIMOD_Requests_Parameters_t))))),&(array_of_statuses[i])); } else { err=PMPI_Recv((*((void**) (((char*) (array_of_statuses))+count*sizeof(MPI_Status)+i**TotalStatusExtension+*StatusOffsetInRequest+request_offset_buf+sizeof(PNMPIMOD_Requests_Parameters_t)))), (*((int*) (((char*) (array_of_statuses))+count*sizeof(MPI_Status)+i**TotalStatusExtension+*StatusOffsetInRequest+request_offset_ct+sizeof(PNMPIMOD_Requests_Parameters_t)))), (*((MPI_Datatype*) (((char*) (array_of_statuses))+count*sizeof(MPI_Status)+i**TotalStatusExtension+*StatusOffsetInRequest+request_offset_dt+sizeof(PNMPIMOD_Requests_Parameters_t)))), array_of_statuses[i].MPI_SOURCE, array_of_statuses[i].MPI_TAG, (*((PNMPIMOD_Requests_Parameters_t*) (((char*) (array_of_statuses))+count*sizeof(MPI_Status)+i**TotalStatusExtension+(*StatusOffsetInRequest)))).comm, &(array_of_statuses[i])); } } if ((*((PNMPIMOD_Requests_Parameters_t*) (((char*) (array_of_statuses))+count*sizeof(MPI_Status)+i**TotalStatusExtension+(*StatusOffsetInRequest)))).type==0x01) { array_of_statuses[i].MPI_ERROR=0; err=PMPI_Wait(&((*((MPI_Request*) (((char*) (array_of_statuses))+count*sizeof(MPI_Status)+i**TotalStatusExtension+*StatusOffsetInRequest+request_offset_req+sizeof(PNMPIMOD_Requests_Parameters_t))))),&(array_of_statuses[i])); } free(ptr);};
     }
 }
    }
